...
Nix fails to install on Fedora 42 based os-tree distros (see https://github.com/DeterminateSystems/nix-installer/issues/1445).
One solution is to pre-create a top-level `/nix` directory in the image.

Following the instructions in [this comment](https://github.com/DeterminateSystems/nix-installer/issues/1445#issuecomment-2816777981),
